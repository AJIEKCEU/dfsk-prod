...
"use strict";$((function(){var e,t,a=$("html").attr("lang"),o={searchText:"Поиск...",noMatch:'Ничего не найдено "{0}"',locale:["OK","Отмена","Выбрать все"],captionFormat:"{0} Выбрано",captionFormatAllSelected:"{0} Все выбраны!",fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}};switch(a){case"ru":default:t={ru:(e=o).fancybox}}var s={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),btnMenu:$(".js-toggle-menu"),mSlider:$(".main__slider"),shadowMenu:$(".nav-shadow"),shadowFilter:$(".filter-shadow"),scrollableElement:document.querySelector(".nav__body"),filter:$(".filter"),filterScrollable:document.querySelector(".filter"),eventMenu:function(){var e=s.win.width();s.nav.toggleClass("nav--open"),s.btnMenu.toggleClass("js-toggle-menu--active"),s.shadowMenu.toggleClass("nav-shadow--active"),s.nav.hasClass("nav--open")&&e<1200?scrollLock.disablePageScroll(s.scrollableElement):scrollLock.enablePageScroll(s.scrollableElement)},showHideFilter:function(){var e=s.win.width();s.filter.toggleClass("filter--show"),s.shadowFilter.toggleClass("filter-shadow--active"),s.filter.hasClass("filter--show")&&e<992?scrollLock.disablePageScroll(s.filterScrollable):scrollLock.enablePageScroll(s.filterScrollable)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}};s.body.on("click",".js-show-filter",(function(){s.showHideFilter()})),s.body.on("click",".filter__close",(function(){s.showHideFilter()})),s.body.on("click",".filter-shadow",(function(e){s.showHideFilter()})),s.selectSearch(),s.selectNoSearch(),$(".barrating").barrating(),s.btnMenu.onclick=function(e){s.eventMenu()},s.shadowMenu.onclick=function(e){s.eventMenu()},s.btnMenu.on("click",(function(){s.eventMenu()})),s.shadowMenu.on("click",(function(){s.eventMenu()})),s.body.on("click",".menu__link-wrp",(function(e){s.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var n=0,l=1;s.win.scroll((function(){var e=s.win.scrollTop(),t=(s.win.outerWidth(),$(this).scrollTop());!function(e,t,a,o){0!==e?(a>n&&e>=o?l&&(l=0,s.header.stop(!0).animate({top:-o},300,(function(){$(this).addClass("header--fixed")}))):l||(l=1,s.header.stop(!0).animate({top:"1.5rem"},300)),n=a):(l=1,s.header.stop(!0).animate({top:"1.5rem"},300,(function(){$(this).removeClass("header--fixed")})))}(e,0,t,s.header.outerHeight()+8),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),s.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),new Swiper(".slider",{spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),new Swiper(".slider-review",{spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider-review__pagination",clickable:!0},navigation:{nextEl:".slider-review__button--next",prevEl:".slider-review__button--prev"}});var i,r=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},pagination:{el:".color-options-slider-pagination",clickable:!0,type:"custom",bulletClass:"color-options-slider-pagination__item"},speed:1200,loop:!0});function c(e,t){var a,o=0,s='<div class="form-message form-message--error">Заполните обязательные поля!</div>',n=t||!1,l=$(e),i=l.data("ajax"),r=l.find('input[type="email"].chk'),c=r.val();if(l.find(".form-message").remove(),l.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),l.find(".form-message").remove(),n.after(s),o=1)})),r.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?r.removeClass("err"):(r.addClass("err"),l.find(".form-message").remove(),n.after(s),o=1)),0===o){if(void 0!==i){l.find("[type=submit]").prop("disabled",!0);var d=new FormData(l.get(0));return!1!==n&&d.append(n.attr("name"),n.val()),$.ajax({type:"POST",url:i,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){l.find(".form-message").remove(),l.find("[type=submit]").prop("disabled",!1),"Y"===(d=JSON.parse(e)).result?(l.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),n.after(d.html)):n.after(d.html)}}),!1}return l.find(".form-message").remove(),!0}return l.find(".form-message").remove(),n.after(s),!1}r.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(r.realIndex).addClass("color-options-slider-pagination__item--is-active")})),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),a=e.querySelector(".picture-gallery-slider__btn--prev"),o=e.querySelector(".picture-gallery-slider__pagination");i=new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:o,clickable:!0},navigation:{nextEl:t,prevEl:a}})})),s.body.on("click",".js-tabs__link",(function(e){e.preventDefault();var t=$(this),a=t.closest(".js-tabs"),o=a.find(".js-tabs__link"),s=a.find(".js-tabs__tab"),n=t.attr("href");o.removeClass("js-tabs__link--is-active"),a.find('.js-tabs__link[href="'+n+'"]').addClass("js-tabs__link--is-active"),s.removeClass("js-tabs__tab--is-show"),(s=$(n)).addClass("js-tabs__tab--is-show"),i.update()})),$("[data-fancybox]").fancybox({lang:a,i18n:t,animationEffect:"fade"}),s.body.on("click",".js-modal-lnk",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",beforeShow:function(e,a){if("#modal-certificate"===a.src){var o=t.attr("data-selectable"),s=$(a.src).find("select.js-select-certificate")[0].sumo;$(a.src).find(".js-select-certificate").next(".optWrapper").find(".opt").removeClass("selected"),void 0!==o?s.selectItem(""+o):s.selectItem(0)}},afterClose:function(){$('.modal input:not([type="submit"]),.modal textarea').removeClass("err"),$(".form-message").remove()}}})})),s.body.on("click",".js-ajax-modal-lnk",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterShow:function(e,a){t.attr("data-before-after")&&$(".js-before-after").twentytwenty({before_label:"До",after_label:"После"})}}})})),$(".js-phone-mask").mask("+375 (99) 999-99-99"),s.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),s.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return c(this);e.preventDefault()})),s.body.on("click","[type = submit]",(function(){return c($(this).closest("form"),$(this))})),window.vaObj=s}));