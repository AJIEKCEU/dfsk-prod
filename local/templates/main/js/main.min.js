...
"use strict";$((function(){var e,t,a=$("html").attr("lang"),o={searchText:"Поиск...",noMatch:'Ничего не найдено "{0}"',locale:["OK","Отмена","Выбрать все"],captionFormat:"{0} Выбрано",captionFormatAllSelected:"{0} Все выбраны!",fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}};switch(a){case"ru":default:t={ru:(e=o).fancybox}}var n={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),btnMenu:$(".js-toggle-menu"),mSlider:$(".main__slider"),shadowMenu:$(".nav-shadow"),shadowFilter:$(".filter-shadow"),scrollableElement:document.querySelector(".nav__body"),filter:$(".filter"),filterScrollable:document.querySelector(".filter"),eventMenu:function(){var e=n.win.width();n.nav.toggleClass("nav--open"),n.btnMenu.toggleClass("js-toggle-menu--active"),n.shadowMenu.toggleClass("nav-shadow--active"),n.nav.hasClass("nav--open")&&e<1200?scrollLock.disablePageScroll(n.scrollableElement):scrollLock.enablePageScroll(n.scrollableElement)},showHideFilter:function(){var e=n.win.width();n.filter.toggleClass("filter--show"),n.shadowFilter.toggleClass("filter-shadow--active"),n.filter.hasClass("filter--show")&&e<992?scrollLock.disablePageScroll(n.filterScrollable):scrollLock.enablePageScroll(n.filterScrollable)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}};n.body.on("click",".js-show-filter",(function(){n.showHideFilter()})),n.body.on("click",".filter__close",(function(){n.showHideFilter()})),n.body.on("click",".filter-shadow",(function(e){n.showHideFilter()})),n.selectSearch(),n.selectNoSearch(),$(".barrating").barrating(),n.btnMenu.onclick=function(e){n.eventMenu()},n.shadowMenu.onclick=function(e){n.eventMenu()},n.btnMenu.on("click",(function(){n.eventMenu()})),n.shadowMenu.on("click",(function(){n.eventMenu()})),n.body.on("click",".menu__link-wrp",(function(e){n.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var l=0,r=1;n.win.scroll((function(){var e=n.win.scrollTop(),t=(n.win.outerWidth(),$(this).scrollTop());!function(e,t,a,o){0!==e?(a>l&&e>=o?r&&(r=0,n.header.stop(!0).animate({top:-o},300,(function(){$(this).addClass("header--fixed")}))):r||(r=1,n.header.stop(!0).animate({top:"1.5rem"},300)),l=a):(r=1,n.header.stop(!0).animate({top:"1.5rem"},300,(function(){$(this).removeClass("header--fixed")})))}(e,0,t,n.header.outerHeight()+8),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),n.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),new Swiper(".slider",{spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),new Swiper(".slider-review",{spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider-review__pagination",clickable:!0},navigation:{nextEl:".slider-review__button--next",prevEl:".slider-review__button--prev"}});var i=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},pagination:{el:".color-options-slider-pagination",clickable:!0,type:"custom",bulletClass:"color-options-slider-pagination__item"},speed:1200,loop:!0});function s(e,t){var a,o=0,n='<div class="form-message form-message--error">Заполните обязательные поля!</div>',l=t||!1,r=$(e),i=r.data("ajax"),s=r.find('input[type="email"].chk'),c=s.val();if(r.find(".form-message").remove(),r.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),r.find(".form-message").remove(),l.after(n),o=1)})),s.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?s.removeClass("err"):(s.addClass("err"),r.find(".form-message").remove(),l.after(n),o=1)),0===o){if(void 0!==i){r.find("[type=submit]").prop("disabled",!0);var f=new FormData(r.get(0));return!1!==l&&f.append(l.attr("name"),l.val()),$.ajax({type:"POST",url:i,data:f,processData:!1,contentType:!1,dataType:"html",success:function(e){r.find(".form-message").remove(),r.find("[type=submit]").prop("disabled",!1),"Y"===(f=JSON.parse(e)).result?(r.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),l.after(f.html)):l.after(f.html)}}),!1}return r.find(".form-message").remove(),!0}return r.find(".form-message").remove(),l.after(n),!1}i.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(i.realIndex).addClass("color-options-slider-pagination__item--is-active")})),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),a=e.querySelector(".picture-gallery-slider__btn--prev"),o=e.querySelector(".picture-gallery-slider__pagination");new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:o,clickable:!0},navigation:{nextEl:t,prevEl:a}})})),$("[data-fancybox]").fancybox({lang:a,i18n:t,animationEffect:"fade"}),n.body.on("click",".js-modal-lnk",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",beforeShow:function(e,a){if("#modal-certificate"===a.src){var o=t.attr("data-selectable"),n=$(a.src).find("select.js-select-certificate")[0].sumo;$(a.src).find(".js-select-certificate").next(".optWrapper").find(".opt").removeClass("selected"),void 0!==o?n.selectItem(""+o):n.selectItem(0)}},afterClose:function(){$('.modal input:not([type="submit"]),.modal textarea').removeClass("err"),$(".form-message").remove()}}})})),n.body.on("click",".js-ajax-modal-lnk",(function(e){e.preventDefault();var t=$(this);$.fancybox.open({src:t.attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterShow:function(e,a){t.attr("data-before-after")&&$(".js-before-after").twentytwenty({before_label:"До",after_label:"После"})}}})})),$(".js-phone-mask").mask("+375 (99) 999-99-99"),n.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),n.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return s(this);e.preventDefault()})),n.body.on("click","[type = submit]",(function(){return s($(this).closest("form"),$(this))})),window.vaObj=n}));